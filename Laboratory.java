...
public class Laboratory {
  ...
  public ArrayList<String> getContactInfos() {
    ...
    for (Student student : students) 
      contacts.add(student.getContactInfo());
    for (Professor professor : professors) 
      contacts.add(professor.getContactInfo());
    return contacts;
  }
  ...
  public boolean userExists(String userId) {
    ...
    for (Student student : students)
      if (student.getUserId().equals(userId)) return true;

    for (Professor professor : professors) 
      if (professor.getUserId().equals(userId)) return true;
    return false;
  }
